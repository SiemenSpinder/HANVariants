...
#path of HTML files
complete_path = r"C:\Users\sieme\Documents\CBS\Industrie\FullHTML\htmloutput"
...
#finds list of URLs
df = pandas.read_excel('IndustrieSelectie.xlsx')
...
newpath = r'C:\Users\sieme\Documents\CBS\textfiles_industrie' 
...
#for each domain create one .txt file containing all the appropriate text
for s in paths:
    cleans = clean_path(s)
